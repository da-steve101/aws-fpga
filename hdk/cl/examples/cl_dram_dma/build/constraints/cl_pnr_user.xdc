...
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/cifar10/vgg/SparseMatMul}]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/cifar10/vgg/SparseMatMul_1}]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/cifar10/vgg/SparseMatMulSerial}]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/cifar10/vgg/SparseMatMulSerial_1}]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/SH_SHIM/DMA_PCIS_AXI_REG_SLC/aw.awpipe}]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/SH_SHIM/DMA_PCIS_AXI_REG_SLC/b.b_pipe}]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/SH_SHIM/DMA_PCIS_AXI_REG_SLC/w.w_pipe}]
#WRAPPER_INST/SH_SHIM/DMA_PCIS_AXI_REG_SLC/b.b_pipe
#WRAPPER_INST/SH_SHIM/DMA_PCIS_AXI_REG_SLC/w.w_pipe
...
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/cifar10/vgg/SparseMatMulSerial_2}]
...
add_cells_to_pblock [get_pblocks pblock_CL_bot] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/cifar10/vgg/SparseMatMulSerial_3}]
...
#WRAPPER_INST/SH_SHIM/DMA_PCIS_AXI_REG_SLC/ar.arpipe
#WRAPPER_INST/SH_SHIM/DMA_PCIS_AXI_REG_SLC/r.r_pipe
