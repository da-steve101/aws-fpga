...
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/ScaleAndShift}]
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/Im2Col_1}]
...
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/ScaleAndShift_1}]
# add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/SimpleBufferLayer}]
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/PoolLayer}]
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/Im2Col_2}]
...
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/ScaleAndShift_2}]
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/Im2Col_3}]
...
#add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/ScaleAndShift_3}]
...
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/PoolLayer_1}]
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/Im2Col_4}]
...
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/ScaleAndShift_4}]
...
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/PoolLayer_2}]
...
# add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/CL_DRAM_DMA_TNN/tnn/vgg/ScaleAndShift_5}]
