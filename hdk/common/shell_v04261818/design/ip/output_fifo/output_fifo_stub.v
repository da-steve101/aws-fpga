...
//               /home/centos/fifo_ip_gen/fifo_ip_gen.srcs/sources_1/ip/output_fifo/output_fifo_stub.v
// Design      : output_fifo
...
module output_fifo(clk, srst, din, wr_en, rd_en, dout, full, empty, valid, 
  wr_rst_busy, rd_rst_busy)
/* synthesis syn_black_box black_box_pad_pin="clk,srst,din[159:0],wr_en,rd_en,dout[159:0],full,empty,valid,wr_rst_busy,rd_rst_busy" */;
  input clk;
  input srst;
  input [159:0]din;
  input wr_en;
